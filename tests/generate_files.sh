...
dd if=/dev/urandom of=../file_fake.zip bs=1 count=10
...
dd if=/dev/urandom of=../file_fake.tar bs=1 count=10

# tar.gz file
rm -f ../file_ok.tar.gz ../file_fake.tar.gz
tar -zcvf ../file_ok.tar.gz *.txt
dd if=/dev/urandom of=../file_fake.tar.gz bs=1 count=10
...
dd if=/dev/urandom of=../file_fake.epub bs=1 count=10
